...
UBUNTU_TRANSLATION_DOMAIN="utweet.francois"
...
aptest.commands = bash $$PWD/UTweet/tests/autopilot/run
aptest.depends  = sub-UTweet

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/UTweet/tests/unit 
unittest.depends  = sub-UTweet
